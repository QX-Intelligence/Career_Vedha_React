...
export const ROLE_PERMISSIONS = {
    ...
    PUBLISHER: [MODULES.ARTICLE_MANAGEMENT, MODULES.QUIZ_MANAGER, MODULES.OVERVIEW_STATS, MODULES.JOB_MANAGEMENT, MODULES.MEDIA_MANAGEMENT, MODULES.ACADEMICS_MANAGEMENT],
    // Legacy support
