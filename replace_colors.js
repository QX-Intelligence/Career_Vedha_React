...
targetFiles.forEach(file => {
    ...
    if (file.endsWith('.css')) {
        content = content
            ...
            // We leave #F59E0B alone if it's explicitly assigned to --warning, but we replaced it previously
            // Wait, let's just do FFC107 and FFB300 first since those are the primary yellows.
